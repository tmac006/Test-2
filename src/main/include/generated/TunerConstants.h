...
class TunerConstants {
    ...
    static constexpr std::string_view kCANBusName = "canivore"; //change
...
private:
    ...
    static constexpr int kPigeonId = 1; //change
...
private:
    ...
    static constexpr int kFrontLeftSteerMotorId = 10;
    ...
    // Front Right
    static constexpr int kFrontRightDriveMotorId = 21;
    ...
    // Back Left
    static constexpr int kBackLeftDriveMotorId = 41;
    static constexpr int kBackLeftSteerMotorId = 40;
    ...
    // Back Right
    static constexpr int kBackRightDriveMotorId = 31;
    static constexpr int kBackRightSteerMotorId = 30;
